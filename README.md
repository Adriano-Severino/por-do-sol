...
Este é o repositório dos projetos da minha linguagem de programação "Por do Sol" uma linguagem de programação moderna escrita em português brasileiro.
...
aqui esta reunidos  os projetos que compõem a linguagem "por do sol" compiladores, interpretadores e ferramentas de desenvolvimento.
...
```text
por-do-sol/
├── compilador/              # compilador-portugues
├── ferramentas-CLI/          # CLI tools
├── net-por-do-sol/           # Framework web
├── pordosol-language-server/ # extensão da linguagem vs code
├── sistema-padrao/          # Biblioteca padrão
├── templates/               # Project templates
├── exemplos/               # Example projects
│   ├── api-simples/
│   ├── crud-completo/
│   └── microservicos/
└── docs/                   # Documentação
